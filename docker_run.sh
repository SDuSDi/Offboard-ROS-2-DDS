...
docker run -it --rm -v /home/bmartinez/workspace/micro_ros2/workspace:/root/workspace --net=host --env DISPLAY=$DISPLAY --privileged braismtnez/ros2dds
# Build command -> docker build -t braismtnez/ros2dds ./workspace/micro_ros2/.